...
execute_process(
  COMMAND "C:/Program Files (x86)/Git/cmd/git.exe" --git-dir=.git show-ref "v5.0.0"
  WORKING_DIRECTORY "C:/Users/ambik/OneDrive/Desktop/demo_project/build/_deps/raylib_cpp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/ambik/OneDrive/Desktop/demo_project/build/_deps/raylib_cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/ambik/OneDrive/Desktop/demo_project/build/_deps/raylib_cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
